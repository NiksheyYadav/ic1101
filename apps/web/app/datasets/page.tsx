      ...
      <div className="grid-2-1 mb-24">
        ...
        <div>
          <div className="card mb-16">
            <h3 style={{ fontSize: 14, fontWeight: 600, marginBottom: 16 }}>Import Summary</h3>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              <div><div style={{ fontSize: 11, color: "var(--text-muted)" }}>File Size</div><div className="mono" style={{ fontSize: 18, fontWeight: 700 }}>2.4 GB</div></div>
              <div><div style={{ fontSize: 11, color: "var(--text-muted)" }}>Rows</div><div className="mono" style={{ fontSize: 18, fontWeight: 700 }}>34,232</div></div>
              <div><div style={{ fontSize: 11, color: "var(--text-muted)" }}>Columns</div><div className="mono" style={{ fontSize: 18, fontWeight: 700 }}>21</div></div>
